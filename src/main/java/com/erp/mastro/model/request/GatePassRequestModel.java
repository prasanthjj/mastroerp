...
public class GatePassRequestModel {
    ...
    public String getsEntryDate() { return MastroApplicationUtils.getStringFromDate(sEntryDate,getEntryDate()); }

    public void setsEntryDate(String sEntryDate) { this.sEntryDate = sEntryDate; }
}
