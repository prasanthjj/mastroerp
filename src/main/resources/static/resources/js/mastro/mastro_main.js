            ...
            $("#ckbCheckAll").click(function () {
                ...
                if($(".checkBoxClass").prop("checked") == true){
                  $(".checkBoxClass").closest('tr').find('input:text,textarea').removeAttr("disabled");
                   $(".checkBoxClass").closest('tr').find('input:text,textarea').prop('required',true);
